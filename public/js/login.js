...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <br><strong><br>O 1º Datacenter do Sul de Minas</strong></h2>
            ...
            <div class="flex">
                ...
                <img alt="Cliente 2" loading="lazy" decoding="async" data-nimg="1" class="rounded-full imgclient border border-white ml" style="color:transparent" src="/modules/addons/custom_features_for_whmcs_halver/public/img/profile2.png">
                <img alt="Cliente 3" loading="lazy" decoding="async" data-nimg="1" class="rounded-full imgclient border border-white ml" style="color:transparent" src="/modules/addons/custom_features_for_whmcs_halver/public/img/profile3.png">
            </div>
